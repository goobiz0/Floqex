...
old_yearly_grid = """          <div className="min-w-0">
...
new_yearly_grid = """          <div className="min-w-0">
...
if old_yearly_grid in content:
    content = content.replace(old_yearly_grid, new_yearly_grid)
else:
    print("WARNING: Yearly grid not found")
