...
export const FeatureRisk = () => {
  ...
  const fillWidth = interpolate(frame, [0, 60], [20, 60], {
  ...
  const percentage = Math.round(interpolate(frame, [0, 60], [0.6, 2.0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  }) * 10) / 10;
  ...
  const shieldOpacity = interpolate(frame, [65, 75], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  const textOpacity = interpolate(frame, [70, 80], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
    ...
    <AbsoluteFill style={{ backgroundColor: COLORS.base, fontFamily: '"Outfit", system-ui, sans-serif', padding: 24, opacity: overallOpacity }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 24 }}>
        <div style={{ position: "relative", width: 200, display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <div style={{ width: "100%", height: 10, backgroundColor: COLORS.surface, borderRadius: RADIUS.pill, position: "relative", overflow: "hidden" }}>
