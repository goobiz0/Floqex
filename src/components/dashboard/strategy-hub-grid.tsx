    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
      <AnimatePresence mode="popLayout">
        {items.map((s, i) => (
          ...
          >
            <div className="group relative flex flex-col p-6 rounded-[var(--radius-card)] bg-surface border border-line hover:border-line-strong transition-[border-color,box-shadow,transform] duration-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] h-full">
