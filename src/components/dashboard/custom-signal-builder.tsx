...
import { TrendUp, TrendDown, Plus, X, Star } from "@phosphor-icons/react";
    ...
    <div className="space-y-5">
      ...
      <div>
        <div className="mb-2 flex items-center gap-1.5">
          ...
          <InfoTip content="Long profits when price rises, short profits when price falls. Your conditions below trigger an entry in this direction." />
        </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-1.5">
          <p className="text-xs font-medium text-fg">Entry conditions</p>
