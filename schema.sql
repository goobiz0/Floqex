...
-- CreateEnum
CREATE TYPE "AgentEventKind" AS ENUM ('INFO', 'SIGNAL', 'TRADE', 'RISK', 'NEWS', 'ADJUST');
...
CREATE TABLE "agent_events" (
    ...
    "kind" "AgentEventKind" NOT NULL DEFAULT 'INFO',
...
-- CreateIndex
CREATE UNIQUE INDEX "connections_accountId_key" ON "connections"("accountId");

-- CreateIndex
CREATE INDEX "agent_events_accountId_ts_idx" ON "agent_events"("accountId", "ts");
...
-- AddForeignKey
ALTER TABLE "agent_events" ADD CONSTRAINT "agent_events_botId_fkey" FOREIGN KEY ("botId") REFERENCES "bots"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "agent_events" ADD CONSTRAINT "agent_events_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "accounts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
